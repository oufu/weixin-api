...
public class TransUtil {
	 ...
	 */
	public static String pack(String pathName, Map data) throws WeixinException {
		String result = null;

		if (pathName.isEmpty()) {
			throw new WeixinException("模板名不能为空！");
		}
		if (data.isEmpty()) {
			throw new WeixinException("打包数据不能为空！");
		}
		try {
			...
			e.printStackTrace();
			throw new WeixinException("数据打包异常！");
		}
	 ...
	 * @throws WeixinException
	 */
	public static Map unPack(String xml) throws WeixinException {
		Map result = null;
		if (xml.isEmpty()) {
			throw new WeixinException("xml值不能为空！");
		}
	...
	public static void main(String[] args) throws IOException,
			TemplateException, WeixinException {
