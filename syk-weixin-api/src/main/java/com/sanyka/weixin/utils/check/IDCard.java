...
public class IDCard {
	...
	final static int[]					PARITYBIT	= { '1', '0', 'X', '9',
			'8', '7', '6', '5', '4', '3', '2'		};
	final static int[]					POWER_LIST	= { 7, 9, 10, 5, 8, 4, 2,
	...
	public static void main(String[] args) {
		final String s = "41142419890507";
		int i = 4000;
		System.out.println(isIdcard("620503199406143232"));
		if (i == 4000)
			return;
		while (i < 5000) {
			String d = s + i++;
			if (isIdcard(d)) {
				System.out.println(d + " --> " + isIdcard(d));
			}
		}
	}
}
